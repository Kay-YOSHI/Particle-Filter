...
#plot(y_t, type = "l", col = 8, ylab = "", main = "Kalman Filter")
#lines(dropFirst(DLMFiltering$m), col = 2, lwd = 2)
#lines(dropFirst(DLMSmoothing$s), col = 4, lwd = 2)
#legend("topright", c("Observation", "Kalman-Filter", "Smoothing"), col = c(8, 2, 4), lty = 1)
